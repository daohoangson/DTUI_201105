...
class XenForo_Route_Prefix_AccountConfirmation implements XenForo_Route_Interface
{
	/**
	...
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		...
		return $router->getRouteMatch('XenForo_ControllerPublic_AccountConfirmation', $action);
	}
