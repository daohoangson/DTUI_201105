...
/**
* Data writer for permission entries for content.
*
* @package XenForo_Permissions
*/
class XenForo_DataWriter_PermissionEntryContent extends XenForo_DataWriter
{
	/**
	...
	*/
	...
	{
		return array(
			'xf_permission_entry_content' => array(
				...
				'permission_value'     => array('type' => self::TYPE_STRING, 'required' => true,
						'allowedValues' => array('unset', 'reset', 'content_allow', 'deny', 'use_int')
				),
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('xf_permission_entry_content' => $this->_getPermissionModel()->getContentPermissionEntryById($id));
	}
